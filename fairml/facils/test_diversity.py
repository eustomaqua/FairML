...
def test_contingency_table():
    ...
    rta, rtb, rtc, rtd = \
        contingency_table_multiclass(tr_yt[ki], tr_yt[kj], tr_y)
    rba, rbb, rbc, rbd = \
        contingency_table_multiclass(bi_yt[ki], bi_yt[kj], bi_y)
...
def test_correlation_coefficient():
    ...
    from fairml.facils.ensem_diversity import Q_Statistic_multi
...
def test_difficulty():
    from fairml.facils.ensem_diversity import difficulty_multiclass
...
def test_pairwise_item():
    from fairml.widget.utils_remark import PAIRWISE
    from fairml.facils.ensem_diversity import (
...
def test_nonpairwise():
    from fairml.widget.utils_remark import NONPAIRWISE
    from fairml.facils.ensem_diversity import (
...
def test_contrastive():
    from fairml.widget.utils_remark import AVAILABLE_NAME_DIVER
